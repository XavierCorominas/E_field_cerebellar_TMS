...
path_to_mri = ['\\l2export\iss02.cenir\analyse\irm\users\martina.bracco\cRETMS_MRIs\2022_04_29_CRETMS_01_002\Head_model\'];% change this by your root folder
...
pwd
[status,cmdout] = system(['C:\Users\vridhi.rohira\Documents\MATLAB\simnibs_env\Scripts\charm',' ',subject_id,' ',filename,' ',filename_2,  ' --forceqform --forcerun'], '-echo');
