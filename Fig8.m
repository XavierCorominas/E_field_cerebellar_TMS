...
% Path to Suit:
addpath('\\l2export\iss02.cenir\software\irm\spm12\toolbox\suit');
...
coil_type = 'figure8';
rmt = 69
intensity = rmt/100*114.7e6

%% Path to originla T1 UNI presurfed;

path_to_mri_nifti = ['\\l2export\iss02.cenir\analyse\irm\users\martina.bracco\cRETMS_MRIs\',date,'_CRETMS_01_',subject_id,'\',sequence,'_T1w_mp2rage_UNI_Images'];

% In case that there is any head model missing, creat it : 
%{
...
%%  Import TMS coil positions for simulation. 
% Select the file corresponding to the desired target to model.
...
(given the differences betwen head models in brainsight and simnins, place
the TMS coil manually in the MNI position with handle upwards), or you want
to change the tms coil you can play with this functions in your simulation:
...
head_1 = mesh_load_gmsh4([save_folder,'\cRETMS_01_',subject_id,'_TMS_1-0001_Magstim_70mm_Fig8_scalar.msh']);
...
% Some fast analyses exploring impact values
...
m = mesh_load_gmsh4([save_folder,'\cRETMS_01_',subject_id,'_TMS_1-0001_Magstim_70mm_Fig8_scalar.msh']);
mesh_show_surface(m);
...
compressedFile = (['cRETMS_01_',subject_id,'_TMS_1-0001_Magstim_70mm_Fig8_scalar_',condition,'.nii.gz']);
outputFile = (['cRETMS_01_',subject_id,'_TMS_1-0001_Magstim_70mm_Fig8_scalar_',condition,'.nii']);
gunzip(compressedFile, outputFile);

% Move to root
sourceFile = ([path_to_mri_nifti,'\Simnibs_simulation\simulation_',coil_pos,'_',coil_type,'\subject_volumes\cRETMS_01_',subject_id,'_TMS_1-0001_Magstim_70mm_Fig8_scalar_',condition,'.nii\cRETMS_01_',subject_id,'_TMS_1-0001_Magstim_70mm_Fig8_scalar_',condition,'.nii']); % Replace with the actual file path
...
job.subj.resample = {['cRETMS_01_',subject_id,'_TMS_1-0001_Magstim_70mm_Fig8_scalar_',condition,'.nii']};
...
spm quit
Data=suit_map2surf(['wdcRETMS_01_',subject_id,'_TMS_1-0001_Magstim_70mm_Fig8_scalar_magnE.nii'],'space','SUIT','stats',@minORmax,'depths', [0.2 0.4 0.6 0.8 1 1.2 1.4 1.6 1.8 2 2.2 2.4 2.6 2.8 3 3.2 3.4 3.78]);
...
data =  suit_ROI_summarize(['wdcRETMS_01_',subject_id,'_TMS_1-0001_Magstim_70mm_Fig8_scalar_magnE.nii'],'atlas', ...
    'C:\Users\vridhi.rohira\Documents\MATLAB\spm12\toolbox\suit\cerebellar_atlases-master\Diedrichsen_2009\atl-Anatom_space-SUIT_dseg.nii','outfilename','lob_info');
save data 
